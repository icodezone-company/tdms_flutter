...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("تفاصيل التوجيه")),
      body: Scrollbar(
        interactive: true,
        ...
        child: Scrollbar(
          ...
          child: TableView.builder(
            ...
            columnCount: OrderDetail.orderDetailHeaders.length,
            ...
            cellBuilder: (context, vicinity) {
              ...
              return TableViewCell(
                child: GestureDetector(
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => TrackingScreen(
                          ...
                          fromSection: null,
                          trackingList:
                              widget.details[vicinity.row - 1].tracking,
                        ),
                      ),
                    );
                  },
                  ...
                  child: JobCell(
                    label: isHeader
                        ? OrderDetail.orderDetailHeaders[vicinity.column]
